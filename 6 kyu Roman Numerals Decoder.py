...
def solution(roman_num : str) -> int:
    ...
    for i in range(1, len(roman_num) - 1):
        ...
        if roman_num[i] == 'V' and roman_num[i - 1] != 'I':
            integer += 5
        elif roman_num[i] == 'V' and roman_num[i - 1] == 'I':
            integer += 4

        if roman_num[i] == 'X' and roman_num[i - 1] != 'I' and roman_num[i + 1] != 'L' and roman_num[i + 1] != 'C':
            integer += 10
        elif roman_num[i] == 'X' and roman_num[i - 1] == 'I' and roman_num[i + 1] != 'L' and roman_num[i + 1] != 'C':
            integer += 9

        if roman_num[i] == 'L' and roman_num[i - 1] != 'X':
            integer += 50
        elif roman_num[i] == 'L' and roman_num[i - 1] == 'X':
            integer += 40

        if roman_num[i] == 'C' and roman_num[i - 1] != 'X' and roman_num[i + 1] != 'D' and roman_num[i + 1] != 'M':
            integer += 100
        elif roman_num[i] == 'C' and roman_num[i - 1] == 'X' and roman_num[i + 1] != 'D' and roman_num[i + 1] != 'M':
            integer += 90

        if roman_num[i] == 'D' and roman_num[i - 1] != 'C':
            integer += 500
        elif roman_num[i] == 'D' and roman_num[i - 1] == 'C':
            integer += 400

        if roman_num[i] == 'M' and roman_num[i - 1] != 'C':
            integer += 1000
